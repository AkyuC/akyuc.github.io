...
<img src="/img/minimind/transformer-word-embedding.png" alt="transformer-word-embedding" style="width: 80%; height: auto; display: block; margin: 0 auto;" />

这里的 token Embedding 实际上就是分词器输出之后，每个词的 ID，比如说 “我” 可能 ID 就是 2，用二进制表示就是只有最低的第二位为 1，其余为 0。

<img src="/img/minimind/transformer-pos-embedding.png" alt="transformer-pos-embedding" style="width: 50%; height: auto; display: block; margin: 0 auto;" />
...
<img src="/img/minimind/sinusoidal-functions.png" alt="sinusoidal-functions" style="width: 50%; height: auto; display: block; margin: 0 auto;"  />
...
<img src="/img/minimind/RoPE.png" alt="RoPE" style="width: 50%; height: auto; display: block; margin: 0 auto;"  />
...
<img src="/img/minimind/KL.png" alt="KL" style="width: 60%; height: auto; display: block; margin: 0 auto;"  />
